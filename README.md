...
- [x] What are PropTypes used for? Please describe why it's important to type check our data in JavaScript.
  ...
  - Describes and typechecks the props that a component expects to receive in order to work correctly.  It's useful, especially as an app grows larger, to avoid errors from props that are missing, or passed in a slightly different form than expected, because a failed proptype leads to a very loud, explicit error printed in the console.

- [x] Describe a life-cycle event in React?

  - Under certain conditions during the life a react class component, certain "life-cycle methods" are automatically invoked, allowing the developer to define certain background behaviors that may not be driven directly by user input.

- [x] Explain the details of a Higher Order Component?

  - A function that accepts one or more components, and returns them, using with either conditional rendering, or other new functions added to them.  One of the primary ways that react developers compose/encapsulate reusable logic in applications.

- [x] What are three different ways to style components in React? Explain some of the benefits of each.

  - Vanilla CSS.  Super straight forward, any web-dev should know how to do it.

  - Inline styles.  Again, simple to start with.  Doesn't require cross referencing an additional stylesheet to reason about.

  - Styled Components.  Probably my favorite.  Allows for well-known, readable css syntax, with the added power of javascript.  Harder upfront learning curve, but seems to allow for the best organization and reusability in the long run.
